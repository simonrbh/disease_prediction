...
labels = data[output_labels].as_matrix().as_type(int)
...
for j in range(nfolds):
	...
	print 'Input variables = '+str(db.train.inputs.shape[1])
	print 'No. label classes = '+str(db.train.labels.shape[1])
