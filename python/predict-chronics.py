...
#dsplit = 20
# Input data
filepath = '/Users/thomas45/dev/data/predict/predict.csv'
...
data['CHRONIC_DX'].ix[(data['Y_HYPERTENSION_DX_DATE_3YR']==1)] = 1
#data['CHRONIC_DX'].ix[(data['Y_DIABETES_DX_DATE_NEXT_3YR']==1)] = 1
#data['CHRONIC_DX'].ix[(data['Y_HYPERLIPIDEMIA_DX_DATE_3YR']==1)] = 1
#data['CHRONIC_DX'].ix[(data['Y_CAD_DX_DATE_3YR']==1)] = 1
...
print 'Total no. features %d'%inputs.shape[1]
# Initialize session
