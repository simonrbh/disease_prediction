...
# popf <- read.csv("C:/Users/simon9/Dropbox (Discovery Limited)/000 Simon H/DSU/Diabetes/all_data_vF.csv", header = TRUE, stringsAsFactors = FALSE, nrows = 100000) 
# write.csv(popf, "popf.csv")
...
popf.hex <- h2o.importFile(path="C:/Users/simon9.DISCOVERY/Dropbox (Discovery Limited)/000 Simon H/DSU/Diabetes/popf.csv")
